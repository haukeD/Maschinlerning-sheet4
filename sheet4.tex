...
S : Klassen "Study"
            "Party"
$$
H(S) = -ld (P("Party")) \cdot P("Party") - ld (P("Study")) \cdot P("Study")
\approx -\frac{5}{11} \cdot -1,137503523749935
   -\frac{6}{11} \cdot -0,874469117916141 
= 0,994030211476957
$$

Wir nehmen das Attribut "Deadline" und wir teilen die Trainingsdaten in 3 Mengen $(S_1,S_2,S_3)$ auf.
Mit:
$S_1$ : Urgent \\
$S_2$ : Near \\
$S_3$ : None \\
...
Wir teilen die Trainingsdaten für das Attribut $B$ "Is there a party?", in Zwei Mengen $$(S_1, S_2)$$ auf, dann ist:
...
Da $Gain(S,B) > Gain(S,A)$ maximiert $Gain(S,B)$ den \textit{information gain}, somit sollte das Attribut $B$ "Is there a party?"
...
\begin{minipage}{\textwidth}
	\includegraphics[scale=0.5]{3c-Gini}
	\includegraphics[scale=0.5]{3c-Information-Gain} \\
	\includegraphics[scale=0.5]{3c-Gain-Ration}
	\includegraphics[scale=0.5]{3c-Random}
	
    \captionof{Decision Tree Options}
\end{minipage}
